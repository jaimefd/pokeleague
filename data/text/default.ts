export const DefaultText: { [id: IDEntry]: DefaultText } = {
	default: {
		...
		tooltipPossibleAbilities: "Possible abilities:",
		tooltipFainted: "(fainted)",
		tooltipBasePower: "Base power: [POWER]",
		tooltipBasePowerVs: "Base power vs [POKEMON]: [POWER]",
		tooltipCantMiss: "can't miss",
		tooltipSuppressedByMagicRoom: " ([ITEM] suppressed by Magic Room)",
		tooltipSuppressedByEmbargo: " ([ITEM] suppressed by Embargo)",
		tooltipSuppressedByKlutz: " ([ITEM] suppressed by Klutz)",
		tooltipSuppressedByGastroAcid: " ([ABILITY] suppressed by Gastro Acid)",
		tooltipSuppressedByWeatherAbility: " ([WEATHER] suppressed by [ABILITY])",
		tooltipModifierFrom: " ([FACTOR]&times; from [SOURCE])",
		tooltipWouldTakeIfAbilityRemoved: "Would take if ability removed:",
		tooltipNextDamage: "Next damage:",
		tooltipTurnsAsleep: "Turns asleep:",
		tooltipPixelsHP: "pixels",
		tooltipPossibleIllusion: "Possible Illusion",
		tooltipItemWas: "[ITEM] was [EFFECT]",
		tooltipWas: "was [ITEM]",
		tooltipNone: "None",
		tooltipAccuracy: "Accuracy: [ACCURACY]",
		tooltipMovesFirst: "Nearly always moves first",
		tooltipMovesLast: "Nearly always moves last",
		tooltipUsuallyFirst: "Usually moves first",
		tooltipPriority: "priority",
		tooltipTransformedInto: "Transformed into",
		tooltipIndistinguishablePokemon: "(Your opponent has two indistinguishable Pokémon, making it impossible for you to tell which one has which moves/ability/item.) ",
		tooltipSpeedBefore: "(before items/abilities/modifiers)",
		tooltipAfterModifiers: "(After stat modifiers:)",
		tooltipTo: " to ",
		tooltipBase: "base:",
		tooltipTeraType: "Tera Type:",
		tooltipTerastallized: "Terastallized",
		tooltipTypeChanged: "Type changed",
		tooltipMoreThanFourMoves: "(More than 4 moves is usually a sign of Illusion Zoroark/Zorua.) ",
		tooltipZEffect: "Z-Effect: [EFFECT]",
		tooltipCalls: "Calls",
		tooltipRevealed: "(revealed)",
		tooltipPressureGen3: "(Pressure is not visible in Gen 3, so in certain situations, more PP may have been lost than shown here.) ",
		tooltipChangedForme: "Changed forme:",
		tooltipThawsOut: "The user thaws out if it is frozen.",
		tooltipHitsAllFoes: "Hits all foes.",
		tooltipCanTargetAnyFoe: "Can target any foe in Free-For-All.",
		tooltipNotBlockedByProtect: "Not blocked by Protect <small>(and Detect, King's Shield, Spiky Shield)</small>",
		tooltipBypassesSubstitute: "Bypasses Substitute <small>(but does not break it)</small>",
		tooltipNotBounceable: "Not bounceable <small>(can't be bounced by Magic Coat/Bounce)</small>",
		tooltipHitsBothFoesAndAlly: "Hits both foes and ally.",
		tooltipHitsBothFoes: "Hits both foes.",
		tooltipHitsAdjacentFoesAndAllies: "Hits adjacent foes and allies.",
		tooltipHitsAdjacentFoes: "Hits adjacent foes.",
		tooltipCanTargetDistantPokemon: "Can target distant Pok&eacute;mon in Triples.",

		tooltipClearNegativeBoost: "Restores negative stat stages to 0",
		tooltipCrit2: "Crit ratio +2",
		tooltipHeal: "Restores HP 100%",
		tooltipCurse: "Restores HP 100% if user is Ghost type, otherwise Attack +1",
		tooltipRedirect: "Redirects opposing attacks to user",
		tooltipHealReplacement: "Restores replacement's HP 100%",

		tooltipContact: "Contact <small>(triggers Iron Barbs, Spiky Shield, etc)</small>",
		tooltipSound: "Sound <small>(doesn't affect Soundproof pokemon)</small>",
		tooltipPowder: "Powder <small>(doesn't affect Grass, Overcoat, Safety Goggles)</small>",
		tooltipPunch: "Fist <small>(boosted by Iron Fist)</small>",
		tooltipPulse: "Pulse <small>(boosted by Mega Launcher)</small>",
		tooltipBite: "Bite <small>(boosted by Strong Jaw)</small>",
		tooltipRecoil: "Recoil <small>(boosted by Reckless)</small>",
		...
		uiWillSwitch: "will switch to",
		uiWillShift: "[POKEMON] will <strong>shift</strong> to the center",
		uiMegaEvolve: "Mega Evolution",
		uiMegaEvolveX: "Mega Evolution X",
		uiMegaEvolveY: "Mega Evolution Y",
		uiUltraBurst: "Ultra Burst",
		uiWillMegaEvolve: "<strong>Mega</strong> Evolve and ",
		uiWillMegaEvolveX: "<strong>Mega</strong> Evolve (X) and ",
		uiWillMegaEvolveY: "<strong>Mega</strong> Evolve (Y) and ",
		uiWillUltraBurst: "<strong>Ultra</strong> Burst and ",
		uiTerastallize: "Terastallize",
		uiGigantamax: "Gigantamax",
		uiDynamax: "Dynamax",
		uiWillGigantamax: "Gigantamax and ",
		uiWillDynamax: "Dynamax and ",
		uiZPower: "Z-Power",
		...
		uiPause: "Pause",
		uiReplay: "Replay",
		uiUploadReplay: "Upload and share replay",
		uiDownloadReplay: "Download replay",
