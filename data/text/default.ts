export const DefaultText: { [id: IDEntry]: DefaultText } = {
	default: {
		...
		tooltipWouldTakeIfAbilityRemoved: "Would take if ability removed: [DAMAGE]%",
		tooltipNextDamage: "Next damage: [DAMAGE]%",
		tooltipTurnsAsleep: "Turns asleep: [TURNS]",
		tooltipPixelsHP: "([HP]/[MAXHP] pixels)",
		tooltipPossibleIllusion: "Possible Illusion #[INDEX]",
		tooltipItemWas: "[ITEM] was [EFFECT]",
		tooltipWas: "was [ITEM]",
		tooltipNone: "None",
		tooltipAccuracy: "Accuracy: [ACCURACY]",
		tooltipTransformedInto: "(Transformed into [FORME])",
		...
		tooltipSpeRange: "<p><small>Spe</small> [MIN] to [MAX] <small>(before items/abilities/modifiers)</small></p>",
		tooltipTo: " to ",
		tooltipBase: "base:",
		...
		tooltipChangedForme: "(Changed forme: [FORME])",
