export const DefaultText: { [id: IDEntry]: DefaultText } = {
	default: {
		...
		tooltipThawsOut: "El usuario se descongela si está congelado.",
		tooltipHitsAllFoes: "Golpea a todos los enemigos.",
		tooltipCanTargetAnyFoe: "Puede apuntar a cualquier enemigo en Free-For-All.",
		tooltipNotBlockedByProtect: "No bloqueado por Protección <small>(y Detección, Escudo real, Barrera espinosa)</small>",
		tooltipBypassesSubstitute: "Evita Sustituto <small>(pero no lo rompe)</small>",
		tooltipNotBounceable: "No rebotable <small>(no puede ser rebotado por Capa mágica/Espejo mágico)</small>",
		tooltipHitsBothFoesAndAlly: "Golpea a ambos enemigos y aliado.",
		tooltipHitsBothFoes: "&#x25ce; Golpea a ambos enemigos.",
		tooltipHitsAdjacentFoesAndAllies: "Golpea a enemigos y aliados adyacentes.",
		tooltipHitsAdjacentFoes: "Golpea a enemigos adyacentes.",
		tooltipCanTargetDistantPokemon: "Puede apuntar a Pok&eacute;mon distantes en Triples.",

		tooltipContact: "Contacto <small>(activa Punta acero, Barrera espinosa, etc)</small>",
		tooltipSound: "Sonido <small>(no afecta a pokemon con Insonorizar)</small>",
		tooltipPowder: "Polvo <small>(no afecta al tipo Planta, pokemon con Funda o Gafa protectora)</small>",
		tooltipPunch: "Puño <small>(potenciado por Puño férreo)</small>",
		tooltipPulse: "Pulso <small>(potenciado por Megadisparador)</small>",
		tooltipBite: "Mordisco <small>(potenciado por Mandíbula fuerte)</small>",
		tooltipRecoil: "Retroceso <small>(potenciado por Audaz)</small>",
