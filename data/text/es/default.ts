export const DefaultText: { [id: IDEntry]: DefaultText } = {
	default: {
		...
		tooltipPossibleAbilities: "Habilidades posibles:",
		...
		tooltipWouldTakeIfAbilityRemoved: "Recibiría si se quita la habilidad:",
		tooltipNextDamage: "Próximo daño:",
		tooltipTurnsAsleep: "Turnos dormido:",
		tooltipPixelsHP: "píxeles",
		tooltipPossibleIllusion: "Posible Ilusión",
		tooltipItemWas: "[ITEM] fue [EFFECT]",
		tooltipWas: "fue [ITEM]",
		tooltipNone: "Ninguno",
		tooltipAccuracy: "Precisión: [ACCURACY]",
		tooltipMovesFirst: "Casi siempre va primero",
		tooltipMovesLast: "Casi siempre va último",
		tooltipUsuallyFirst: "Suele ir primero",
		tooltipPriority: "prioridad",
		tooltipTransformedInto: "Transformado en",
		...
		tooltipSpeedBefore: "(antes de objetos/habilidades/modificadores)",
		tooltipAfterModifiers: "(Tras cambios de estadística:)",
		tooltipTo: " a ",
		tooltipBase: "base:",
		...
		tooltipChangedForme: "Forma cambiada:",
		...
		tooltipClearNegativeBoost: "Restaura los cambios de estado negativos a 0",
		tooltipCrit2: "Índice de crítico +2",
		tooltipHeal: "Restaura PS 100%",
		tooltipCurse: "Restaura PS 100% si el usuario es tipo Fantasma, si no Ataque +1",
		tooltipRedirect: "Redirige ataques rivales al usuario",
		tooltipHealReplacement: "Restaura PS 100% del reemplazo",
		...
		uiWillSwitch: "cambiará por",
		uiWillShift: "[POKEMON] se <strong>moverá</strong> al centro",
		uiMegaEvolve: "Megaevolución",
		uiMegaEvolveX: "Megaevolución (X)",
		uiMegaEvolveY: "Megaevolución (Y)",
		uiUltraBurst: "Ultraexplosión",
		uiWillMegaEvolve: "<strong>Megaevolucionar</strong> y ",
		uiWillMegaEvolveX: "<strong>Megaevolucionar</strong> (X) y ",
		uiWillMegaEvolveY: "<strong>Megaevolucionar</strong> (Y) y ",
		uiWillUltraBurst: "<strong>Ultraexplosionar</strong> y ",
		uiTerastallize: "Teracristalizar",
		uiGigantamax: "Gigamax",
		uiDynamax: "Dinamax",
		uiWillGigantamax: "Gigamaxizar y ",
		uiWillDynamax: "Dinamaxizar y ",
		uiZPower: "Poder Z",
		...
		uiAtSlot: "en la posición",
		uiAtAllySlot: "en la posición aliada",
		uiAt: "contra",
		uiAtAlly: "en el aliado",
		uiAnd: "y",
		...
		uiPause: "Pausar",
		uiReplay: "Repetir",
		uiUploadReplay: "Subir y compartir repetición",
		uiDownloadReplay: "Descargar repetición",
