export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	metronome: {
		name: "Metrónomo",
		desc: "Se selecciona un movimiento al azar para usar, excepto Abrecaminos, Adaptación, Agua fría, Aguante, Alarido, Amago, Amplificador, Anticipo, Antojo, Ascenso draco, Asalto estelar, Autotomía, Ayuda, Azote torrencial, Ácido málico, Balón ígneo, Barrera espinosa, Batería asalto, Brinco, Búnker, Cabeza sorpresa, Calamidad, Cambiapoder, Canto arcaico, Cañón armadura, Cañón Dinamax, Cañón floral, Cautivapor, Cede paso, Celebración, Cepo, Cerco dimensión, Cháchara, Choque anímico, Chorro de vapor, Ciclón primavera, Contraataque, Copión, Coraza trampa, Cura selvática, Decalcomanía, Decoración, Deslome, Detección, Dracoenergía, Electroderrape, Electrojaula, Electropalmas, Embate supremo, Eructo, Erupción de ira, Escudo real, Escudo tatami, Esquema, Espejo, Estruendo escama, Extracto picante, Feerichoque, Ferropuño doble, Fiebre dorada, Filo del abismo, Foco, Forcejeo, Fría acogida, Fuerza G, Furia candente, Furia natural, Furia taurina, Géiser fotónico, Golpe oscuro, Gota vital, Hipertaladro, Irreverencia, Ladrón, Lanza glacial, Láser doble, Limpieza general, Llama gélida, Luz aniquiladora, Mandato, Manos juntas, Manto espejo, Metaláser, Meteoimpacto, Metrónomo, Mil flechas, Mil temblores, Mimético, Mirada heladora, Mismo destino, Nitrochoque, Obstrucción, Ofrenda, Oído cocina, Ominochoque, Orbes espectro, Paisaje nevado, Paso dimensional, Patada relámpago, Pico cañón, Pirochoque, Plancha corporal, Plegaria vital, Polvo ira, Ponzochoque, Proliferación, Protección, Pugnachoque, Pulso primigenio, Punzada rama, Puño certero, Puño furia, Puño jet, Puños plasma, Rayo gélido, Rayo infinito, Rayo umbrío, Refuerzo, Resarcimiento, Robo, Robasombra, Ronquido, Rueda aural, Sable místico, Salazón, Señuelo, Sonámbulo, Tajo supremo, Tecno shock, Telatrampa, Teraclúster, Tormenta de diamantes, Transformación, Trapicheo, Truco, Truco defensa, Último lugar, V de fuego, Vasta guardia, Vasto impacto o Yo primero",
		shortDesc: "Elige un movimiento al azar.",
		gen8: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Adaptación, Aguante, Alarido, Amago, Amplificador, Anticipo, Antojo, Ascenso draco, Asalto estelar, Ayuda, Azote torrencial, Ácido málico, Balón ígneo, Barrera espinosa, Batería asalto, Búnker, Cabeza sorpresa, Canto arcaico, Cañón Dinamax, Cañón floral, Cautivapor, Cede paso, Celebración, Cepo, Cerco dimensión, Cháchara, Choque anímico, Chorro de vapor, Contraataque, Copión, Coraza trampa, Cura selvática, Decoración, Detección, Dracoenergía, Electrojaula, Embate supremo, Eructo, Escudo real, Escudo tatami, Esquema, Espejo, Estruendo escama, Ferropuño doble, Filo del abismo, Foco, Forcejeo, Fuerza G, Furia candente, Furia natural, Géiser fotónico, Golpe oscuro, Gota vital, Irreverencia, Ladrón, Lanza glacial, Llama gélida, Luz aniquiladora, Mandato, Manos juntas, Manto espejo, Martillo dragón, Metaláser, Meteoimpacto, Metrónomo, Mil flechas, Mil temblores, Mimético, Mirada heladora, Mismo destino, Obstrucción, Ofrenda, Orbes espectro, Paso dimensional, Patada relámpago, Pico cañón, Plancha corporal, Polvo ira, Protección, Pulso primigenio, Punzada rama, Puño certero, Puños plasma, Rayo gélido, Rayo infinito, Rayo umbrío, Refuerzo, Robo, Robasombra, Ronquido, Rueda aural, Sable místico, Señuelo, Sonámbulo, Tajo supremo, Tecno shock, Tormenta de diamantes, Transformación, Trapicheo, Truco, Truco defensa, Último lugar, V de fuego, Vasta guardia, Vasto impacto o Yo primero.",
		},
		gen7: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Adaptación, Aguante, Alarido, Amago, Anticipo, Antojo, Ascenso draco, Ayuda, Barrera espinosa, Búnker, Cabeza sorpresa, Canto arcaico, Cañón floral, Cede paso, Celebración, Cerco dimensión, Cháchara, Chorro de vapor, Contraataque, Copión, Coraza trampa, Detección, Eructo, Escudo real, Escudo tatami, Espejo, Esquema, Filo del abismo, Foco, Forcejeo, Géiser fotónico, Ladrón, Llama gélida, Luz aniquiladora, Mandato, Manos juntas, Manto espejo, Metrónomo, Mil flechas, Mil temblores, Mimético, Mismo destino, Ofrenda, Paso dimensional, Pico cañón, Polvo ira, Protección, Pulso primigenio, Puño certero, Puños plasma, Rayo gélido, Refuerzo, Robo, Robasombra, Ronquido, Sable místico, Señuelo, Sonámbulo, Tecno shock, Tormenta de diamantes, Transformación, Trapicheo, Truco, Truco defensa, Último lugar, V de fuego, Vasta guardia o Yo primero.",
		},
		gen6: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Adaptación, Aguante, Alarido, Amago, Anticipo, Antojo, Ascenso draco, Ayuda, Barrera espinosa, Canto arcaico, Cede paso, Celebración, Cerco dimensión, Cháchara, Chorro de vapor, Contraataque, Copión, Detección, Eructo, Escudo real, Escudo tatami, Espejo, Esquema, Filo del abismo, Forcejeo, Ladrón, Llama gélida, Luz aniquiladora, Manos juntas, Manto espejo, Metrónomo, Mil flechas, Mil temblores, Mimético, Mismo destino, Ofrenda, Paso dimensional, Polvo ira, Protección, Pulso primigenio, Puño certero, Rayo gélido, Refuerzo, Robo, Ronquido, Sable místico, Señuelo, Sonámbulo, Tecno shock, Tormenta de diamantes, Transformación, Trapicheo, Truco, Truco defensa, Último lugar, V de fuego, Vasta guardia o Yo primero.",
		},
		gen5: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Adaptación, Aguante, Alarido, Amago, Anticipo, Antojo, Ayuda, Canto arcaico, Cede paso, Cháchara, Contraataque, Copión, Detección, Espejo, Esquema, Forcejeo, Ladrón, Llama gélida, Manto espejo, Metrónomo, Mimético, Mismo destino, Ofrenda, Polvo ira, Protección, Puño certero, Rayo gélido, Refuerzo, Robo, Ronquido, Sable místico, Señuelo, Sonámbulo, Tecno shock, Transformación, Trapicheo, Truco, Último lugar, V de fuego, Vasta guardia o Yo primero.",
		},
		gen4: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Aguante, Amago, Antojo, Ayuda, Cháchara, Contraataque, Copión, Detección, Espejo, Esquema, Forcejeo, Ladrón, Manto espejo, Metrónomo, Mimético, Mismo destino, Protección, Puño certero, Refuerzo, Robo, Señuelo, Sonámbulo, Trapicheo, Truco, Yo primero, o cualquier movimiento que el usuario ya conozca.",
		},
		gen3: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Aguante, Antojo, Contraataque, Detección, Esquema, Forcejeo, Ladrón, Manto espejo, Metrónomo, Mimético, Mismo destino, Protección, Puño certero, Refuerzo, Robo, Señuelo, Sonámbulo o Truco.",
		},
		gen2: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Aguante, Contraataque, Detección, Esquema, Forcejeo, Ladrón, Manto espejo, Metrónomo, Mimético, Mismo destino, Protección, Sonámbulo, o cualquier movimiento que el usuario ya conozca.",
		},
		gen1: {
			desc: "Se selecciona un movimiento al azar para usar, excepto Forcejeo o Metrónomo.",
		},
	...
	thunder: {
		name: "Trueno",
		desc: "Tiene un 30 % de probabilidad de paralizar al objetivo. Este movimiento puede golpear a un objetivo que esté usando Bote, Vuelo o Caída libre, o bajo el efecto de Caída libre. Si el clima es Mar del albor o Danza lluvia, este movimiento no comprueba precisión. Si el clima es Tierra del ocaso o Día soleado, la precisión de este movimiento es del 50 %. Si se usa este movimiento contra un Pokémon que lleve equipado un parasol multiuso, su precisión permanece en 70 %.",
		shortDesc: "30 % parál. No falla en lluvia.",
		gen7: {
			desc: "Tiene un 30 % de probabilidad de paralizar al objetivo. Este movimiento puede golpear a un objetivo que esté usando Bote, Vuelo o Caída libre, o bajo el efecto de Caída libre. Si el clima es Mar del albor o Danza lluvia, este movimiento no comprueba precisión. Si el clima es Tierra del ocaso o Día soleado, la precisión de este movimiento es del 50 %.",
		},
		gen5: {
			desc: "Tiene un 30 % de probabilidad de paralizar al objetivo. Este movimiento puede golpear a un objetivo que esté usando Bote, Vuelo o Caída libre, o bajo el efecto de Caída libre. Si el clima es Danza lluvia, este movimiento no comprueba precisión. Si el clima es Día soleado, la precisión de este movimiento es del 50 %.",
		},
		gen4: {
			desc: "Tiene un 30 % de probabilidad de paralizar al objetivo. Este movimiento puede golpear a un objetivo que esté usando Bote o Vuelo. Si el clima es Danza lluvia, este movimiento no comprueba precisión. Si el clima es Día soleado, la precisión de este movimiento es del 50 %.",
		},
		gen2: {
			desc: "Tiene un 30 % de probabilidad de paralizar al objetivo. Este movimiento puede golpear a un objetivo que esté usando Vuelo. Si el clima es Danza lluvia, este movimiento no comprueba precisión. Si el clima es Día soleado, la precisión de este movimiento es del 50 %.",
		},
		gen1: {
			desc: "Tiene un 10 % de probabilidad de paralizar al objetivo.",
			shortDesc: "10 % de probabilidad de paralizar al objetivo.",
		},
	},
	thunderbolt: {
		name: "Rayo",
	...
	thundercage: {
		name: "Electrojaula",
		desc: "Evita que el objetivo cambie durante cuatro o cinco turnos (siete turnos si el usuario lleva equipada Garra garfio). Inflige daño al objetivo equivalente a 1/8 de sus PS máximos (1/6 si el usuario lleva equipada Banda atadura), redondeado hacia abajo, al final de cada turno mientras persiste el efecto. El objetivo puede cambiarse si lleva equipada Muda concha o si usa Relevo, Viraje, Última palabra, Autotomía, Teletransporte, Ida y vuelta o Voltiocambio. El efecto termina si el usuario o el objetivo abandonan el campo, o si el objetivo usa con éxito Giro mortífero, Giro rápido o Sustituto. Este efecto no es acumulable ni se reinicia al usar este u otro movimiento de apresamiento.",
		shortDesc: "Atrapa y daña al objetivo 4-5 turnos.",
		gen8: {
			desc: "Evita que el objetivo cambie durante cuatro o cinco turnos (siete turnos si el usuario lleva equipada Garra garfio). Inflige daño al objetivo equivalente a 1/8 de sus PS máximos (1/6 si el usuario lleva equipada Banda atadura), redondeado hacia abajo, al final de cada turno mientras persiste el efecto. El objetivo puede cambiarse si lleva equipada Muda concha o si usa Relevo, Viraje, Última palabra, Teletransporte, Ida y vuelta o Voltiocambio. El efecto termina si el usuario o el objetivo abandonan el campo, o si el objetivo usa con éxito Giro rápido o Sustituto. Este efecto no es acumulable ni se reinicia al usar este u otro movimiento de apresamiento.",
		},
		start: "  [SOURCE] trapped [POKEMON]!",
	},
	thunderclap: {
		name: "Relámpago súbito",
		desc: "Falla si el objetivo no ha seleccionado un ataque físico, un ataque especial o Yo primero en ese turno, o si el objetivo actúa antes que el usuario.",
		shortDesc: "Normalmente va primero. Falla si el objetivo no ataca.",
	},
	thunderfang: {
		name: "Colmillo rayo",
		desc: "Tiene un 10% de probabilidad de paralizar al objetivo y un 10% de probabilidad de hacerlo retroceder.",
		shortDesc: "10% prob. paralizar. 10% prob. retroceso.",
	},
	thunderouskick: {
		name: "Patada relámpago",
		desc: "Causa daño y siempre baja la Defensa del objetivo en 1 nivel.",
		shortDesc: "100% prob. baja Def. en 1 nivel.",
	},
	thunderpunch: {
		name: "Puño trueno",
		desc: "Tiene un 10% de probabilidad de paralizar al objetivo.",
		shortDesc: "10% prob. de paralizar al objetivo.",
	},
	thundershock: {
		name: "Impactrueno",
		desc: "Tiene un 10% de probabilidad de paralizar al objetivo.",
	...
	tickle: {
		name: "Cosquillas",
		desc: "Baja un nivel el Ataque y la Defensa del objetivo.",
		shortDesc: "Baja 1 Atq. y Def. al objetivo.",
	},
	tidyup: {
		name: "Limpieza general",
		desc: "Sube un nivel el Ataque y la Velocidad del usuario. Elimina Sustitutos de todos los Pokémon activos y finaliza los efectos de Púas, Trampa rocas, Red viscosa y Púas tóxicas en ambos bandos.",
		shortDesc: "Usuario +1 Atq., Vel. Elimina Sustitutos/peligros.",
		activate: "  ¡Limpieza general completada!",
	},
	topsyturvy: {
		name: "Reversión",
		desc: "Los cambios de estadísticas del objetivo se invierten. Falla si todos los cambios de estadísticas del objetivo son 0.",
		shortDesc: "Invierte los cambios de estadísticas del objetivo.",
	},
	torchsong: {
		name: "Canto ardiente",
		desc: "Tiene un 100 % de probabilidad de subir 1 nivel el Atq. Esp. del usuario.",
		shortDesc: "100 % prob. subir 1 nivel Atq. Esp.",
	},
	torment: {
		name: "Tormento",
		desc: "Evita que el objetivo seleccione el mismo movimiento dos turnos seguidos. Este efecto termina cuando el objetivo ya no está activo.",
		shortDesc: "El objetivo no puede usar el mismo movimiento dos veces seguidas.",
		start: "  ¡[POKEMON] fue sometido a tormento!",
		end: "  ¡[POKEMON] ya no está sometido a tormento!",
	},
	toxic: {
		name: "Tóxico",
		desc: "Envenena gravemente al objetivo. Si un Pokémon de tipo Veneno usa este movimiento, el objetivo no puede evitar el ataque, incluso si está en medio de un movimiento de dos turnos.",
		shortDesc: "Envenena gravemente al objetivo. Los de tipo Veneno no pueden fallar.",
		gen5: {
			desc: "Envenena gravemente al objetivo.",
			shortDesc: "Envenena gravemente al objetivo.",
		},
	},
	toxicspikes: {
		name: "Púas tóxicas",
		desc: "Coloca un obstáculo en el lado opuesto del campo que envenena a cada Pokémon rival que entra en combate, a menos que sea de tipo Volador o tenga la habilidad Levitación. Se puede usar hasta dos veces antes de fallar. Los Pokémon rivales se envenenan con una capa y se envenenan gravemente con dos capas. Se elimina del campo rival si un Pokémon usa Limpieza general, o si un Pokémon rival usa con éxito Giro mortífero, Giro rápido o Despejar, es alcanzado por Despejar o si entra en combate un Pokémon de tipo Veneno en tierra. Velo sagrado impide que el bando rival se envenene al entrar, pero Sustituto no.",
		shortDesc: "Envenena a rivales al entrar. Máx. 2 capas.",
		gen8: {
			desc: "Coloca un obstáculo en el lado opuesto del campo que envenena a cada Pokémon rival que entra en combate, a menos que sea de tipo Volador o tenga la habilidad Levitación. Se puede usar hasta dos veces antes de fallar. Los Pokémon rivales se envenenan con una capa y se envenenan gravemente con dos capas. Se elimina del campo rival si un Pokémon rival usa con éxito Giro rápido o Despejar, es alcanzado por Despejar o si entra en combate un Pokémon de tipo Veneno en tierra. Velo sagrado impide que el bando rival se envenene al entrar, pero Sustituto no.",
		},
		gen5: {
			desc: "Coloca un obstáculo en el lado opuesto del campo que envenena a cada Pokémon rival que entra en combate, a menos que sea de tipo Volador o tenga la habilidad Levitación. Se puede usar hasta dos veces antes de fallar. Los Pokémon rivales se envenenan con una capa y se envenenan gravemente con dos capas. Se elimina del campo rival si un Pokémon rival usa con éxito Giro rápido, es alcanzado por Despejar o si entra en combate un Pokémon de tipo Veneno en tierra. Velo sagrado impide que el bando rival se envenene al entrar, pero Sustituto no.",
		},
		gen4: {
			desc: "Coloca un obstáculo en el lado opuesto del campo que envenena a cada Pokémon rival que entra en combate, a menos que sea de tipo Volador o tenga la habilidad Levitación. Se puede usar hasta dos veces antes de fallar. Los Pokémon rivales se envenenan con una capa y se envenenan gravemente con dos capas. Se elimina del campo rival si un Pokémon rival usa con éxito Giro rápido, es alcanzado por Despejar o si entra en combate un Pokémon de tipo Veneno en tierra. Velo sagrado impide que el bando rival se envenene al entrar, así como al entrar con un Sustituto.",
		},

		start: "  ¡Se esparcieron púas tóxicas por todo [TEAM]!",
		end: "  ¡Las púas tóxicas desaparecieron del suelo alrededor de [TEAM]!",
	},
	toxicthread: {
		name: "Hilo venenoso",
		desc: "Reduce la Velocidad del objetivo 1 nivel y lo envenena.",
		shortDesc: "Baja 1 nivel Velocidad y envenena.",
	},
	trailblaze: {
		name: "Abrecaminos",
		desc: "Tiene 100% de probabilidad de subir la Velocidad del usuario 1 nivel.",
		shortDesc: "100% prob. sube 1 nivel Velocidad.",
	},
	transform: {
		name: "Transformación",
		desc: "El usuario se transforma en el objetivo. Se copian las estadísticas actuales del objetivo, los niveles de estadística, los tipos, los movimientos, la Habilidad, el peso, el género y el sprite. El nivel y los PS del usuario permanecen igual y cada movimiento copiado recibe solo 5 PP, con un máximo de 5 PP cada uno. El usuario ya no puede cambiar de forma si tuviera la capacidad de hacerlo. Este movimiento falla si golpea a un Sustituto, si el usuario o el objetivo ya está transformado, o si cualquiera está bajo una Ilusión.",
		shortDesc: "Copia Est., mov., tipos y Háb. del objetivo.",
		gen4: {
			desc: "El usuario se transforma en el objetivo. Se copian las estadísticas actuales del objetivo, los niveles de estadística, los tipos, los movimientos, la Habilidad, el peso, los IV, la especie y el sprite. El nivel y los PS del usuario permanecen igual y cada movimiento copiado recibe solo 5 PP. Este movimiento falla si el objetivo ya se ha transformado.",
		},
		gen2: {
			desc: "El usuario se transforma en el objetivo. Se copian las estadísticas actuales del objetivo, los niveles de estadística, los tipos, los movimientos, los DV, la especie y el sprite. El nivel y los PS del usuario permanecen igual y cada movimiento copiado recibe solo 5 PP. Este movimiento falla si el objetivo ya se ha transformado.",
			shortDesc: "Copia Est., mov., tipos y especie del objetivo.",
		},
		gen1: {
			desc: "El usuario se transforma en el objetivo. Se copian las estadísticas actuales del objetivo, los niveles de estadística, los tipos, los movimientos, los DV, la especie y el sprite. El nivel y los PS del usuario permanecen igual y cada movimiento copiado recibe solo 5 PP. Este movimiento puede golpear a un objetivo que esté usando Excavar o Vuelo.",
		},
		transform: "¡[POKEMON] se transformó en [SPECIES]!",
	},
	triattack: {
		name: "Triataque",
		desc: "Tiene un 20 % de probabilidad de quemar, congelar o paralizar al objetivo.",
		shortDesc: "20 % prob. de quemar, congelar o paralizar al objetivo.",
		gen2: {
			desc: "Este movimiento selecciona aleatoriamente quemar, congelar o paralizar, con un 20 % de probabilidad de infligir ese estado al objetivo. Si el objetivo está congelado y se elige quemar, se descongela.",
		},
		gen1: {
			desc: "Sin efecto adicional.",
			shortDesc: "Sin efecto adicional.",
	...
	trick: {
		name: "Truco",
		desc: "El usuario intercambia el objeto que lleva con el del objetivo. Falla si el usuario o el objetivo lleva una carta, si ninguno lleva objeto, si el usuario intenta dar o quitar una megapiedra a o de la especie que puede Megaevolucionar con ella, o si el usuario intenta dar o quitar un Prisma azul, un Prisma rojo, una griseosfera, una tabla, un cartucho o un disco a o de un Kyogre, un Groudon, un Giratina, un Arceus, un Genesect o un Silvally, respectivamente. El objetivo es inmune a este movimiento si tiene la habilidad Viscosidad.",
		shortDesc: "El usuario intercambia su objeto con el del objetivo.",
		gen6: {
			desc: "El usuario intercambia el objeto que lleva con el del objetivo. Falla si el usuario o el objetivo lleva una carta, si ninguno lleva objeto, si el usuario intenta dar o quitar una megapiedra a o de la especie que puede Megaevolucionar con ella, o si el usuario intenta dar o quitar un Prisma azul, un Prisma rojo, una griseosfera, una tabla o un cartucho a o de un Kyogre, un Groudon, un Giratina, un Arceus o un Genesect, respectivamente. El objetivo es inmune a este movimiento si tiene la habilidad Viscosidad.",
		},
		gen5: {
			desc: "El usuario intercambia el objeto que lleva con el del objetivo. Falla si el usuario o el objetivo lleva una carta, si ninguno lleva objeto, o si el usuario intenta dar o quitar una Griseosfera, una tabla o un cartucho a o de un Giratina, un Arceus o un Genesect, respectivamente. El objetivo es inmune a este movimiento si tiene la habilidad Viscosidad.",
		},
		gen4: {
			desc: "El usuario intercambia el objeto que lleva con el del objetivo. Falla si el usuario o el objetivo lleva una carta o una Griseosfera, si ninguno lleva objeto, si cualquiera tiene la habilidad Multitipo, si cualquiera está bajo el efecto de Desarme, o si el objetivo tiene la habilidad Viscosidad.",
		},
		gen3: {
			desc: "El usuario intercambia el objeto que lleva con el del objetivo. Falla si el usuario o el objetivo lleva una carta, si ninguno lleva objeto, si cualquiera está bajo el efecto de Desarme, o si el objetivo tiene la habilidad Viscosidad.",
		},
		activate: "  ¡[POKEMON] intercambió objetos con su objetivo!",
	},
	trickortreat: {
		name: "Halloween",
		desc: "Añade el tipo Fantasma al objetivo, haciendo que tenga dos o tres tipos. Falla si el objetivo ya es de tipo Fantasma. Si Condena silvana añade un tipo, este reemplaza al tipo añadido por este movimiento y viceversa.",
		shortDesc: "Añade Fantasma a los tipos del objetivo.",
	},
	trickroom: {
		name: "Espacio raro",
		desc: "Durante 5 turnos, la Velocidad de cada Pokémon se recalcula a efectos de determinar el orden de turno. Mientras dura el efecto, la Velocidad de cada Pokémon se considera (10000 - su Velocidad normal), y si este valor es mayor que 8191, se le resta 8192. Si este movimiento se usa durante el efecto, este finaliza.",
		shortDesc: "Va último. Invierte el orden de turno durante 5 turnos.",
		gen4: {
			desc: "Durante 5 turnos, todos los Pokémon activos con menor Velocidad se moverán antes que los de mayor Velocidad, respetando sus intervalos de prioridad. Si este movimiento se usa durante el efecto, este finaliza.",
		},
	},
	triplearrows: {
		name: "Triple flecha",
		desc: "Tiene un 50% de probabilidad de bajar la Defensa del objetivo 1 nivel, un 30% de probabilidad de hacerlo retroceder y una mayor probabilidad de asestar un golpe crítico.",
		shortDesc: "Alto crítico. 50% prob. baja Def., 30% prob. retroceso.",
	},
	tripleaxel: {
		name: "Triple axel",
		desc: "Golpea tres veces. La potencia aumenta a 40 en el segundo golpe y a 60 en el tercero. Este movimiento comprueba la precisión en cada golpe; el ataque termina si el objetivo evita uno. Si uno de los golpes rompe el Sustituto del objetivo, recibirá daño de los golpes restantes. Si el usuario tiene la habilidad Encadenado, este movimiento siempre golpea tres veces.",
		shortDesc: "Golpea 3 veces; puede fallar, poder aumenta.",
	},
	tripledive: {
		name: "Triple inmersión",
		desc: "Golpea tres veces.",
		shortDesc: "Golpea 3 veces.",
	},
	triplekick: {
		name: "Triple patada",
		desc: "Golpea tres veces. La potencia aumenta a 20 en el segundo golpe y a 30 en el tercero. Comprueba la precisión en cada golpe; el ataque termina si el objetivo evade uno. Si uno de los golpes destruye el Sustituto del objetivo, este recibirá daño de los golpes restantes. Si el usuario tiene la habilidad Encadenado, este movimiento siempre golpeará tres veces.",
		shortDesc: "Golpea 3 veces. Cada golpe puede fallar, potencia aumenta.",
		gen4: {
			desc: "Golpea tres veces. La potencia aumenta a 20 en el segundo golpe y a 30 en el tercero. Comprueba la precisión en cada golpe; el ataque termina si el objetivo evade uno. Si uno de los golpes destruye el Sustituto del objetivo, este recibirá daño de los golpes restantes. Si el objetivo tiene una Banda focus y contaba con todos sus PS al comenzar este movimiento, no se debilitará sin importar el número de golpes.",
		},
		gen3: {
			desc: "Golpea tres veces. La potencia aumenta a 20 en el segundo golpe y a 30 en el tercero. Comprueba la precisión en cada golpe; el ataque termina si el objetivo evade uno. Si uno de los golpes destruye el Sustituto del objetivo, este recibirá daño de los golpes restantes.",
		},
		gen2: {
			desc: "Golpea de 1 a 3 veces al azar. La potencia aumenta a 20 en el segundo golpe y a 30 en el tercero.",
			shortDesc: "Golpea 1-3 veces. Pot. sube c/ golpe.",
		},
	},
	tropkick: {
		name: "Patada tropical",
		desc: "Tiene un 100% de probabilidad de bajar 1 nivel el Ataque del objetivo.",
		shortDesc: "100% prob. de bajar 1 nivel el Ataque del objetivo.",
	},
	trumpcard: {
		name: "As oculto",
		desc: "La potencia de este movimiento se basa en la cantidad de PP restantes tras la reducción normal de PP y la resolución de la habilidad Presión. 200 de potencia con 0 PP, 80 con 1 PP, 60 con 2 PP, 50 con 3 PP y 40 con 4 o más PP.",
		shortDesc: "Más potente cuanto menos PP queden.",
	},
	twinbeam: {
		name: "Láser doble",
		desc: "Golpea dos veces. Si el primer golpe rompe el Sustituto del objetivo, este recibirá daño en el segundo golpe.",
		shortDesc: "Golpea 2 veces en un turno.",
	},
	twineedle: {
		name: "Doble ataque",
		desc: "Golpea dos veces, cada golpe tiene un 20 % de probabilidad de envenenar al objetivo. Si el primer golpe rompe el Sustituto del objetivo, este recibirá daño en el segundo golpe.",
		shortDesc: "Golpea 2 veces. Cada golpe tiene 20 % prob. de envenenar.",
		gen4: {
			desc: "Golpea dos veces, cada golpe tiene un 20 % de probabilidad de envenenar al objetivo. Si el primer golpe rompe el Sustituto del objetivo, este recibirá daño en el segundo golpe. Si el objetivo lleva una Banda aguante y tenía los PS al máximo al comenzar este movimiento, no caerá debilitado sin importar el número de golpes.",
		},
		gen3: {
			desc: "Golpea dos veces, cada golpe tiene un 20 % de probabilidad de envenenar al objetivo. Si el primer golpe rompe el Sustituto del objetivo, este recibirá daño en el segundo golpe.",
		},
		gen2: {
			desc: "Golpea dos veces, la segunda vez tiene un 20 % de probabilidad de envenenar al objetivo. Si el primer golpe rompe el Sustituto del objetivo, este recibirá daño en el segundo golpe pero no podrá envenenarse por él.",
			shortDesc: "Golpea 2 veces. Último golpe tiene 20 % prob. de envenenar.",
		},
		gen1: {
			desc: "Golpea dos veces, la segunda vez tiene un 20 % de probabilidad de envenenar al objetivo. Si el primer golpe rompe el Sustituto del objetivo, el movimiento termina.",
		},
	},
	twinkletackle: {
		name: "Arrumaco sideral",
		shortDesc: "Potencia igual al poder Z base.",
	},
	twister: {
		name: "Ciclón",
		desc: "Tiene un 20% de probabilidad de hacer retroceder al objetivo. La potencia se duplica si el objetivo está usando Bote, Vuelo o Caída libre, o está bajo el efecto de Caída libre.",
		shortDesc: "20% prob. de retroceso.",
		gen4: {
			desc: "Tiene un 20% de probabilidad de hacer retroceder al objetivo. La potencia se duplica si el objetivo está usando Bote o Vuelo.",
		},
		gen2: {
			desc: "Tiene un 20% de probabilidad de hacer retroceder al objetivo. La potencia se duplica si el objetivo está usando Vuelo.",
			shortDesc: "20% prob. de retroceso.",
		},
	},
	uturn: {
		name: "Ida y vuelta",
		desc: "Si este movimiento tiene éxito y el usuario no se ha debilitado, cambia de inmediato por un miembro seleccionado del equipo, incluso si está atrapado. El usuario no cambia si no hay miembros no debilitados en el equipo, o si el objetivo cambió usando Botón escape o por el efecto de las habilidades Retirada o Cobardía.",
		shortDesc: "El usuario cambia tras dañar al objetivo.",
		gen6: {
			desc: "Si este movimiento tiene éxito y el usuario no se ha debilitado, cambia de inmediato por un miembro seleccionado del equipo, incluso si está atrapado. El usuario no cambia si no hay miembros no debilitados en el equipo, o si el objetivo cambió usando Botón escape.",
		},
		gen4: {
			desc: "Si este movimiento tiene éxito y el usuario no se ha debilitado, cambia de inmediato por un miembro seleccionado del equipo, incluso si está atrapado. El usuario no cambia si no hay miembros no debilitados en el equipo.",
		},
		switchOut: "[POKEMON] regresó con [TRAINER]!",
	},
	upperhand: {
		name: "Palma rauda",
		desc: "Tiene un 100 % de probabilidad de amedrentar al objetivo. Falla si el objetivo no selecciona un movimiento prioritario este turno o si actúa antes que el usuario.",
		shortDesc: "100 % prob. de amedrentar al objetivo. Falla si el objetivo no usa mov. prioritario.",
	},
	uproar: {
		name: "Alboroto",
		desc: "El usuario pasa tres turnos bloqueado en este movimiento. Cada turno apunta a un oponente al azar. En el primero de los tres turnos, todos los Pokémon activos dormidos despiertan. Durante esos turnos, ningún Pokémon activo puede quedarse dormido por ningún medio y los que entren durante el efecto no despiertan. Si el usuario no puede actuar o el ataque no tiene éxito contra el objetivo en alguno de los turnos, el efecto termina.",
		shortDesc: "Dura 3 turnos. Pokémon activos no pueden dormir.",
		gen6: {
			desc: "El usuario pasa tres turnos bloqueado en este movimiento. Cada turno apunta a un oponente adyacente al azar. En el primero, todos los Pokémon activos dormidos despiertan. Durante esos turnos, ningún Pokémon activo puede quedarse dormido por ningún medio y los que entren durante el efecto no despiertan. Si el usuario no puede actuar o el ataque falla, el efecto termina.",
		},
		gen4: {
			desc: "El usuario pasa de tres a seis turnos bloqueado en este movimiento. Cada turno apunta a un oponente al azar. Durante el efecto, ningún Pokémon activo puede quedarse dormido por ningún medio y los que ya estén dormidos despiertan al iniciar o finalizar cada turno, incluido el último. Si el usuario no puede actuar o el ataque falla, el efecto termina.",
			shortDesc: "Dura 3-6 turnos. Pokémon activos no pueden dormir.",
		},
		gen3: {
			desc: "El usuario pasa de dos a cinco turnos bloqueado en este movimiento. Cada turno apunta a un Pokémon oponente al azar. Durante el efecto, ningún Pokémon activo puede quedarse dormido por ningún medio y los que ya estén dormidos despiertan al iniciar o finalizar cada turno, incluido el último. Si el usuario no puede actuar o el ataque falla, el efecto termina.",
			shortDesc: "Dura 2-5 turnos. Pokémon activos no pueden dormir.",
		},

		start: "  ¡[POKEMON] provocó un alboroto!",
		end: "  [POKEMON] se calmó.",
		upkeep: "  ¡[POKEMON] está provocando un alboroto!",
		block: "  ¡Pero el alboroto mantuvo despierto a [POKEMON]!",
		blockSelf: "  ¡[POKEMON] no puede dormir durante un alboroto!",
	},
	vacuumwave: {
		name: "Onda vacío",
		desc: "Sin efecto adicional.",
	...
	vcreate: {
		name: "V de fuego",
		desc: "Reduce en un nivel la Velocidad, la Defensa y la Defensa especial del usuario.",
		shortDesc: "Reduce Def., Def. Esp. y Vel. en 1.",
	},
	veeveevolley: {
		name: "Eevimpacto",
		desc: "La potencia depende de la felicidad del usuario: mayor felicidad x 2/5 (redondeado) o 1. Este movimiento nunca falla.",
		shortDesc: "Felicidad máx.: 102 pot. No falla.",
	},
	venomdrench: {
		name: "Trampa venenosa",
		desc: "Reduce en un nivel el Ataque, el Ataque especial y la Velocidad del objetivo si está envenenado. Falla si no lo está.",
		shortDesc: "Reduce 1 nivel Atq./Atq. Esp./Vel. de rivales envenenados.",
	},
	venoshock: {
		name: "Carga tóxica",
		desc: "La potencia se duplica si el objetivo está envenenado.",
		shortDesc: "Potencia x2 si el objetivo está envenenado.",
	},
	victorydance: {
		name: "Danza triunfal",
		desc: "Sube 1 nivel el Ataque, la Defensa y la Velocidad del usuario.",
		shortDesc: "Sube Atq., Def. y Vel. en 1.",
	},
	vinewhip: {
		name: "Látigo cepa",
		shortDesc: "Sin efecto adicional.",
	...
	vitalthrow: {
		name: "Llave vital",
		desc: "Este movimiento no comprueba la precisión.",
		shortDesc: "Este movimiento no comprueba la precisión. Va último.",
	},
	voltswitch: {
		name: "Voltiocambio",
		desc: "Si este movimiento tiene éxito y el usuario no se ha debilitado, cambia de inmediato por un miembro seleccionado del equipo, incluso si está atrapado. El usuario no cambia si no hay miembros no debilitados en el equipo, o si el objetivo cambió usando Botón escape o por el efecto de las habilidades Retirada o Cobardía.",
	...
	volttackle: {
		...
		desc: "Tiene un 10 % de probabilidad de paralizar al objetivo. Si el objetivo perdió PS, el usuario recibe un daño de retroceso igual al 33 % de los PS perdidos, redondeado medio hacia arriba, pero no menos de 1 PS.",
		shortDesc: "33 % de retroceso. 10 % de prob. de paralizar al objetivo.",
		gen4: {
			desc: "Tiene un 10 % de probabilidad de paralizar al objetivo. Si el objetivo perdió PS, el usuario recibe un daño de retroceso igual a 1/3 de los PS perdidos, redondeado hacia abajo, pero no menos de 1 PS.",
			shortDesc: "1/3 de retroceso. 10 % de prob. de paralizar al objetivo.",
		},
		gen3: {
			desc: "Si el objetivo perdió PS, el usuario recibe un daño de retroceso igual a 1/3 de los PS perdidos, redondeado hacia abajo, pero no menos de 1 PS.",
			shortDesc: "1/3 de retroceso.",
		},
	},
	wakeupslap: {
		name: "Espabila",
		desc: "La potencia se duplica si el objetivo está dormido. Si el usuario no se debilita, el objetivo despierta.",
		shortDesc: "Pot. x2 si el objetivo está dormido; lo despierta.",
		gen4: {
			desc: "La potencia se duplica si el objetivo está dormido. Si este movimiento tiene éxito, el objetivo despierta.",
		},
	},
	waterfall: {
		name: "Cascada",
	...
	waterpledge: {
		name: "Voto agua",
		desc: "Si uno de los aliados del usuario eligió usar Voto fuego o Voto planta este turno y aún no ha actuado, actuará inmediatamente después del usuario y el movimiento del usuario no hace nada. Si se combina con Voto fuego, el aliado usa Voto agua con 150 de potencia y aparece un arcoíris en el cielo del lado del usuario durante 4 turnos, lo que duplica las probabilidades de efectos secundarios y se acumula con la habilidad Dicha, excepto que los efectos que causan retroceso solo pueden duplicar su probabilidad una vez. Si se combina con Voto planta, el aliado usa Voto planta con 150 de potencia y aparece un pantano en el lado del objetivo durante 4 turnos, lo que reduce a la cuarta parte la Velocidad de cada Pokémon en ese lado. Cuando se usa como movimiento combinado, este movimiento adquiere STAB independientemente del tipo del usuario. Este movimiento no consume la Gema agua del usuario y no puede ser redirigido por la habilidad Colector.",
		shortDesc: "Úsalo con Voto planta o Voto fuego para efecto extra.",
		activate: "  [POKEMON] está esperando el movimiento de [TARGET]...",
		start: "  ¡Apareció un arcoíris en el cielo del lado de [TEAM]!",
		end: "  ¡El arcoíris en el lado de [TEAM] desapareció!",
	},
	waterpulse: {
		name: "Hidropulso",
		desc: "Tiene un 20% de probabilidad de confundir al objetivo.",
		shortDesc: "20% prob. confundir.",
	},
	watershuriken: {
		name: "Shuriken de agua",
		desc: "Golpea de dos a cinco veces. Tiene un 35 % de probabilidad de golpear dos o tres veces y un 15 % de probabilidad de golpear cuatro o cinco veces. Si uno de los golpes destruye el Sustituto del objetivo, este recibirá daño de los golpes restantes. Si el usuario tiene la Habilidad Encadenado, este movimiento siempre golpeará cinco veces. Si el usuario es un Greninja de Ash con la habilidad Fuerte afecto, este movimiento tiene una potencia de 20 y siempre golpea tres veces. Si el usuario lleva el Dado trucado, este movimiento golpeará de 4 a 5 veces.",
		shortDesc: "Suele ir primero. Golpea 2-5 veces en un turno.",
		gen8: {
			desc: "Golpea de dos a cinco veces. Tiene un 35 % de probabilidad de golpear dos o tres veces y un 15 % de probabilidad de golpear cuatro o cinco veces. Si uno de los golpes destruye el Sustituto del objetivo, este recibirá daño de los golpes restantes. Si el usuario tiene la Habilidad Encadenado, este movimiento siempre golpeará cinco veces.",
		},
		gen6: {
	...
	watersport: {
		name: "Hidrochorro",
		desc: "Durante 5 turnos, todos los ataques de tipo Fuego usados por cualquier Pokémon activo tienen su potencia multiplicada por 0,33. Falla si este efecto ya está activo.",
		shortDesc: "Durante 5 turnos, ataques de Fuego 1/3 de potencia.",
		gen5: {
			desc: "Mientras el usuario esté activo, todos los ataques de tipo Fuego usados por cualquier Pokémon activo tienen su potencia multiplicada por 0,33. Falla si este efecto ya está activo para algún Pokémon.",
			shortDesc: "Debilita ataques de Fuego a 1/3 de su potencia.",
		},
		gen4: {
			desc: "Mientras el usuario esté activo, todos los ataques de tipo Fuego usados por cualquier Pokémon activo tienen su potencia reducida a la mitad. Falla si este efecto ya está activo para el usuario. Pase de Renglón puede usarse para transferir este efecto a un aliado.",
			shortDesc: "Debilita ataques de Fuego a 1/2 de su potencia.",
		},
	},
	waterspout: {
		name: "Salpicar",
		desc: "La potencia es igual a (PS actuales del usuario x 150 / PS máximos del usuario), redondeado hacia abajo, pero no menos de 1.",
		shortDesc: "Menos potencia a medida que bajan los PS del usuario. Golpea al(s) oponente(s).",
	},
	wavecrash: {
		name: "Envite acuático",
		desc: "Si el objetivo perdió PS, el usuario recibe daño de retroceso igual al 33 % de los PS perdidos por el objetivo, redondeado al alza, pero no menos de 1 PS.",
		shortDesc: "33 % retroceso.",
	},
	weatherball: {
		name: "Meteorobola",
		desc: "La potencia se duplica si hay un clima activo distinto de Ráfaga delta, y el tipo de este movimiento cambia para coincidir: tipo Hielo durante Nieve, tipo Agua durante Mar del albor o Danza lluvia, tipo Roca durante Tormenta arena y tipo Fuego durante Tierra del ocaso o Día soleado. Si el usuario lleva equipado el Parasol multiuso y usa Meteorobola durante Mar del albor, Danza lluvia, Tierra del ocaso o Día soleado, este movimiento permanece tipo Normal y no duplica su potencia.",
		shortDesc: "Potencia x2 y tipo varía en cada clima.",
		gen8: {
			desc: "La potencia se duplica si hay un clima activo distinto de Ráfaga delta, y el tipo de este movimiento cambia para coincidir: tipo Hielo durante Granizo, tipo Agua durante Mar del albor o Danza lluvia, tipo Roca durante Tormenta arena y tipo Fuego durante Tierra del ocaso o Día soleado. Si el usuario lleva equipado el Parasol multiuso y usa Meteorobola durante Mar del albor, Danza lluvia, Tierra del ocaso o Día soleado, este movimiento permanece tipo Normal y no duplica su potencia.",
		},
		gen5: {
			desc: "La potencia se duplica si hay un clima activo y el tipo de este movimiento cambia para coincidir: tipo Hielo durante Granizo, tipo Agua durante Danza lluvia, tipo Roca durante Tormenta arena y tipo Fuego durante Día soleado.",
		},
		gen3: {
			desc: "El daño se duplica y el tipo de este movimiento cambia según el clima activo: tipo Hielo durante Granizo, tipo Agua durante Danza lluvia, tipo Roca durante Tormenta arena y tipo Fuego durante Día soleado.",
			shortDesc: "Daño x2 y tipo varía durante clima.",
		},
		move: "  ¡Carrera arrolladora se convirtió en [MOVE] debido al clima!",
	},
	whirlpool: {
		name: "Torbellino",
		desc: "Impide que el objetivo cambie de Pokémon durante cuatro o cinco turnos (siete turnos si el usuario lleva equipada una Garra garfio). Causa al objetivo un daño idéntico a 1/8 de sus PS máximos (1/6 si el usuario lleva equipada una Banda atadura), redondeado hacia abajo, al final de cada turno durante el efecto. El objetivo aún puede cambiar si lleva equipada una Muda concha o usa Relevo, Viraje, Última palabra, Autotomía, Teletransporte, Ida y vuelta o Voltiocambio. El efecto termina si el usuario o el objetivo abandona el campo, o si el objetivo usa Giro mortífero, Giro rápido o Sustituto con éxito. Este efecto no es acumulable ni se restablece al usar este u otro movimiento de atadura.",
		shortDesc: "Atrapa y daña al objetivo 4-5 turnos.",
		gen8: {
			desc: "Impide que el objetivo cambie de Pokémon durante cuatro o cinco turnos (siete turnos si el usuario lleva equipada una Garra garfio). Causa al objetivo un daño idéntico a 1/8 de sus PS máximos (1/6 si el usuario lleva equipada una Banda atadura), redondeado hacia abajo, al final de cada turno durante el efecto. El objetivo aún puede cambiar si lleva equipada una Muda concha o usa Relevo, Viraje, Última palabra, Teletransporte, Ida y vuelta o Voltiocambio. El efecto termina si el usuario o el objetivo abandona el campo, o si el objetivo usa Giro rápido o Sustituto con éxito. Este efecto no es acumulable ni se restablece al usar este u otro movimiento de atadura.",
		},
		...
		gen5: {
			desc: "Impide que el objetivo cambie de Pokémon durante cuatro o cinco turnos (siete turnos si el usuario lleva equipada una Garra garfio). Causa al objetivo un daño idéntico a 1/16 de sus PS máximos (1/8 si el usuario lleva equipada una Banda atadura), redondeado hacia abajo, al final de cada turno durante el efecto. El objetivo aún puede cambiar si lleva equipada una Muda concha o usa Relevo, Ida y vuelta o Voltiocambio. El efecto termina si el usuario o el objetivo abandona el campo, o si el objetivo usa Giro rápido o Sustituto con éxito. Este efecto no es acumulable ni se restablece al usar este u otro movimiento de atadura.",
		},
		gen4: {
			desc: "Impide que el objetivo cambie de Pokémon durante dos a cinco turnos (siempre cinco turnos si el usuario lleva equipada una Garra garfio). Causa al objetivo un daño idéntico a 1/16 de sus PS máximos, redondeado hacia abajo, al final de cada turno durante el efecto. El objetivo aún puede cambiar si lleva equipada una Muda concha o usa Relevo o Ida y vuelta. El efecto termina si el usuario o el objetivo abandona el campo, o si el objetivo usa Giro rápido o Sustituto con éxito. Este efecto no es acumulable ni se restablece al usar este u otro movimiento de atadura.",
			shortDesc: "Atrapa y daña al objetivo 2-5 turnos.",
		},
		gen3: {
			desc: "Impide que el objetivo cambie de Pokémon durante dos a cinco turnos. Causa al objetivo un daño idéntico a 1/16 de sus PS máximos, redondeado hacia abajo, al final de cada turno durante el efecto. El objetivo aún puede cambiar si usa relevo. El efecto termina si el usuario o el objetivo abandona el campo, o si el objetivo usa giro rápido o sustituto con éxito. Este efecto no es acumulable ni se restablece al usar este u otro movimiento de atadura.",
		},

		start: "  [POKEMON] quedó atrapado en el torbellino!",
	},
	whirlwind: {
		name: "Remolino",
		desc: "El objetivo es obligado a cambiar y ser reemplazado por un aliado al azar que no esté debilitado. Falla si es el último Pokémon no debilitado de su equipo, si el objetivo usó Arraigo anteriormente o tiene la habilidad Ventosas.",
		shortDesc: "Obliga al objetivo a cambiar por un aliado al azar.",
		gen4: {
			desc: "El objetivo es obligado a cambiar y ser reemplazado por un aliado al azar que no esté debilitado. Falla si es el último Pokémon no debilitado de su equipo, si el objetivo usó Arraigo anteriormente, tiene la habilidad Ventosas o si el nivel del usuario es menor que el del objetivo y X × (nivel usuario + nivel objetivo)/256 + 1 ≤ (nivel objetivo/4), redondeado hacia abajo, donde X es un número aleatorio de 0 a 255.",
		},
		gen2: {
			desc: "El objetivo es obligado a cambiar y ser reemplazado por un aliado al azar que no esté debilitado. Falla si es el último Pokémon no debilitado de su equipo o si el usuario actúa antes que el objetivo.",
		},
		gen1: {
			desc: "Sin uso competitivo.",
			shortDesc: "Sin uso competitivo.",
	...
	wickedblow: {
		name: "Golpe oscuro",
		desc: "Este movimiento siempre resulta en un golpe crítico, a menos que el objetivo esté bajo el efecto de Conjuro o tenga la habilidad Armadura batalla o Caparazón.",
		shortDesc: "Siempre es golpe crítico.",
	},
	wickedtorque: {
		name: "Ominochoque",
		desc: "Tiene un 10 % de probabilidad de causar que el objetivo se duerma.",
		shortDesc: "10 % de prob. de dormir al objetivo.",
	},
	wideguard: {
		name: "Vasta guardia",
		desc: "El usuario y los miembros de su equipo están protegidos durante este turno de los movimientos de otros Pokémon, incluidos los aliados, que tienen como blanco a todos los rivales o a todos los Pokémon adyacentes. Este ataque modifica la misma probabilidad 1/X de éxito usada por otros movimientos de protección, donde X empieza en 1 y se triplica cada vez que se usa con éxito, pero no aplica la comprobación de fallo. X vuelve a 1 si falla, si el último movimiento usado por el usuario no es Búnker, Llama protectora, Detección, Aguante, Escudo real, Maxibarrera, Obstrucción, Protección, Anticipo, Telatrampa, Barrera espinosa o Vasta guardia, o si fue uno de esos movimientos y su protección quedó rota. Falla si el usuario actúa al final del turno o si este efecto ya está activo en su bando.",
		shortDesc: "Protege al equipo de ataques múltiples este turno.",
		gen8: {
			desc: "El usuario y los miembros de su equipo están protegidos de los ataques de otros Pokémon, incluidos los aliados, durante este turno, si tienen como blanco a todos los rivales o a todos los Pokémon adyacentes. Falla si el usuario actúa al final del turno o si este efecto ya está activo en su bando.",
		},
		gen7: {
			desc: "El usuario y los miembros de su equipo están protegidos de los ataques de otros Pokémon, incluidos los aliados, durante este turno, si tienen como blanco a todos los rivales o a todos los Pokémon adyacentes. Falla si el usuario actúa al final del turno o si este efecto ya está activo en su bando.",
		},
		gen6: {
			desc: "El usuario y los miembros de su equipo están protegidos de ataques de otros Pokémon que tienen como blanco a todos los rivales o a todos los Pokémon adyacentes durante este turno. Falla si el usuario actúa al final del turno o si este efecto ya está activo en su bando.",
			shortDesc: "Protege al equipo de ataques múltiples este turno.",
		},
		gen5: {
			desc: "El usuario y los miembros de su equipo están protegidos de los ataques de otros Pokémon que tienen como blanco a todos los rivales o a todos los Pokémon adyacentes durante este turno.",
		},
		start: "  ¡Vasta guardia protegió al equipo!",
		block: "  ¡Vasta guardia protegió a [POKEMON]!",
	},
	wildboltstorm: {
		name: "Electormenta",
		desc: "Tiene un 20 % de probabilidad de paralizar al objetivo. Si el clima es Mar del albor o Danza lluvia, este movimiento no comprueba precisión. Si se usa contra un Pokémon que lleva equipado un parasol multiuso, la precisión de este movimiento sigue siendo del 80 %.",
		shortDesc: "20 % de paralizar. Lluvia: no falla.",
	},
	wildcharge: {
		name: "Voltio cruel",
		desc: "Si el objetivo pierde PS, el usuario recibe un daño de retroceso igual a 1/4 de los PS perdidos por el objetivo, redondeado por exceso, pero no menos de 1 PS.",
		shortDesc: "Retroceso 1/4.",
	},
	willowisp: {
		name: "Fuego fatuo",
		desc: "Quema al objetivo.",
		shortDesc: "Quema al objetivo.",
	},
	wingattack: {
		name: "Ataque ala",
		shortDesc: "Sin efecto adicional.",
	...
	wish: {
		name: "Deseo",
		desc: "Al final del siguiente turno, el Pokémon en la posición del usuario recupera la mitad de los PS máximos del usuario, redondeado hacia abajo. Falla si este movimiento ya está en efecto en la posición del usuario.",
		shortDesc: "Siguiente turno, restaura 50 % de PS máx. del usuario.",
		gen4: {
			desc: "Al final del siguiente turno, el Pokémon en la posición del usuario recupera la mitad de sus PS máximos, redondeado hacia abajo. Falla si este movimiento ya está en efecto en la posición del usuario.",
			shortDesc: "Siguiente turno, cura 50 % de PS máx. del receptor.",
		},

		heal: "  ¡Se cumplió el Deseo de [NICKNAME]!",
	},
	withdraw: {
		name: "Refugio",
		desc: "Sube un nivel la Defensa del usuario.",
		shortDesc: "Sube 1 Def. al usuario.",
	},
	wonderroom: {
		name: "Zona extraña",
		desc: "Durante 5 turnos, todos los Pokémon activos tienen intercambiadas sus estadísticas de Defensa y Defensa Especial. Los cambios de nivel no se ven afectados. Si se usa este movimiento mientras el efecto está activo, el efecto termina.",
		shortDesc: "Dura 5 turnos. Def. y Def. Esp. se intercambian.",
	},
	woodhammer: {
		name: "Mazazo",
		desc: "Si el objetivo perdió PS, el usuario recibe un daño de retroceso igual al 33 % de los PS perdidos, redondeado medio hacia arriba, pero no menos de 1 PS.",
		shortDesc: "33 % de retroceso.",
		gen4: {
			desc: "Si el objetivo perdió PS, el usuario recibe un daño de retroceso igual a 1/3 de los PS perdidos, redondeado hacia abajo, pero no menos de 1 PS.",
			shortDesc: "1/3 de retroceso.",
		},
	...
	workup: {
		name: "Avivar",
		desc: "Alza el Ataque y el Ataque especial 1 nivel.",
		shortDesc: "Sube Atq. y Atq. Esp. 1 nivel.",
	},
	worryseed: {
		name: "Abatidoras",
		desc: "Hace que la habilidad del objetivo pase a ser Insomnio. Falla si la habilidad del objetivo es Unidad ecuestre, Fuerte afecto, Letargo perenne, Disfraz, Tragamisil, Cara de hielo, Insomnio, Multitipo, Agrupamiento, Sistema Alfa, Banco, Escudo limitado, Cambio táctico, Teracambio, Pereza, Modo daruma o Cambio heroico.",
		shortDesc: "La habilidad del objetivo pasa a ser Insomnio.",
		gen8: {
			desc: "Hace que la habilidad del objetivo pase a ser Insomnio. Falla si la habilidad del objetivo es Unidad ecuestre, Fuerte afecto, Letargo perenne, Disfraz, Tragamisil, Cara de hielo, Insomnio, Multitipo, Agrupamiento, Sistema Alfa, Banco, Escudo limitado, Cambio táctico, Teracambio, Pereza, Modo daruma o Cambio heroico.",
		},
		gen7: {
			desc: "Hace que la habilidad del objetivo pase a ser Insomnio. Falla si la habilidad del objetivo es Unidad ecuestre, Fuerte afecto, Letargo perenne, Disfraz, Tragamisil, Cara de hielo, Insomnio, Multitipo, Agrupamiento, Sistema Alfa, Banco, Escudo limitado, Cambio táctico, Pereza, Modo daruma o Cambio heroico.",
		},
		gen6: {
			desc: "Hace que la habilidad del objetivo pase a ser Insomnio. Falla si la habilidad del objetivo es Insomnio, Multitipo, Cambio táctico o Pereza.",
		},
		gen5: {
			desc: "Hace que la habilidad del objetivo pase a ser Insomnio. Falla si la habilidad del objetivo es Insomnio, Multitipo o Pereza.",
		},
		gen4: {
			desc: "Hace que la habilidad del objetivo pase a ser Insomnio. Falla si la habilidad del objetivo es Multitipo o Pereza, o si el objetivo lleva equipada una Griseosfera.",
		},
	},
	wrap: {
		name: "Constricción",
		desc: "Impide que el objetivo cambie de posición durante cuatro o cinco turnos (siete turnos si el usuario lleva equipada la Garra garfio). Inflige daño al objetivo igual a 1/8 de sus PS máximos (1/6 si el usuario lleva la Banda atadura), redondeado hacia abajo, al final de cada turno durante el efecto. El objetivo aún puede cambiarse si lleva la Muda concha o usa Relevo, Viraje, Última palabra, Autotomía, Teletransporte, Ida y vuelta o Voltiocambio. El efecto termina si el usuario o el objetivo abandona el campo, o si el objetivo usa Giro mortífero, Giro rápido o Sustituto con éxito. Este efecto no es acumulable ni se reinicia al usar este u otro movimiento de atadura.",
		shortDesc: "Atrapa y daña al objetivo 4-5 turnos.",
		gen8: {
			desc: "Impide que el objetivo cambie de posición durante cuatro o cinco turnos (siete si el usuario lleva Garra garfio). Inflige daño igual a 1/8 de sus PS máximos al final de cada turno.",
		},
		gen7: {
			desc: "Impide que el objetivo cambie de posición durante cuatro o cinco turnos (siete si el usuario lleva Garra garfio). Inflige daño igual a 1/8 de sus PS máximos al final de cada turno.",
		},
		gen5: {
			desc: "Impide que el objetivo cambie de posición durante cuatro o cinco turnos (siete si el usuario lleva Garra garfio). Inflige daño igual a 1/16 de sus PS máximos al final de cada turno.",
		},
		gen4: {
			desc: "Impide que el objetivo cambie de posición durante dos a cinco turnos (cinco si el usuario lleva Garra garfio). Inflige daño igual a 1/16 de sus PS máximos al final de cada turno. El objetivo aún se cambia si usa Relevo o Ida y vuelta.",
			shortDesc: "Atrapa y daña al objetivo 2-5 turnos.",
		},
		gen3: {
			desc: "Impide que el objetivo cambie de posición durante dos a cinco turnos. Inflige daño igual a 1/16 de sus PS máximos al final de cada turno. El objetivo aún puede cambiar si usa Relevo.",
		},
		gen1: {
			desc: "El usuario emplea este movimiento durante dos a cinco turnos. Tiene 3/8 de probabilidad de durar dos o tres turnos, y 1/8 de durar cuatro o cinco. El daño calculado en el primer turno se repite cada turno. El usuario y el objetivo no pueden ejecutar movimientos durante el efecto, pero ambos pueden cambiarse. El efecto termina si cualquiera cambia o si el usuario no puede mover. Afecta aunque el objetivo tenga inmunidad de tipo, pero no causa daño.",
			shortDesc: "Impide que el objetivo se mueva 2-5 turnos.",
		},

		start: "  ¡[POKEMON] fue envuelto por [SOURCE]!",
		move: "¡El ataque de [POKEMON] continúa!",
	},
	wringout: {
		name: "Estrujón",
		desc: "Causa daño dependiendo de los PS del objetivo: cuantos más PS tenga, más daño inflige.",
		shortDesc: "Más daño cuanto más PS tenga el objetivo.",
		gen4: {
			desc: "Inflige daño según la fórmula 1 + 120·(PS actuales/PS máximos), redondeado hacia abajo.",
		},
	},
	xscissor: {
		name: "Tijera X",
	...
	yawn: {
		name: "Bostezo",
		desc: "Provoca que el objetivo caiga dormido al final del siguiente turno. Falla si el objetivo no puede dormir o ya tiene un estado alterado no volátil. Al final del siguiente turno, si el objetivo sigue en combate, no tiene un estado alterado no volátil y puede dormir, cae dormido. Este efecto no puede prevenirse con Velo sagrado ni con Sustituto, ni por dormir y despertar durante su duración.",
		shortDesc: "Duerme al objetivo tras 1 turno.",
		start: "  [POKEMON] empezó a bostezar!",
	},
	zapcannon: {
		name: "Electrocañón",
		desc: "Tiene un 100 % de probabilidad de paralizar al objetivo.",
		shortDesc: "100 % de paralizar.",
	},
	zenheadbutt: {
		name: "Cabezazo zen",
		desc: "Tiene un 20 % de probabilidad de hacer retroceder al objetivo.",
		shortDesc: "20 % de retroceder.",
	},
	zingzap: {
		name: "Electropunzada",
		desc: "Tiene un 30 % de probabilidad de amedrentar al objetivo.",
		shortDesc: "30 % prob. de amedrentar al objetivo.",
	},
	zippyzap: {
		name: "Pikaturbo",
		desc: "Tiene un 100 % de probabilidad de subir 1 nivel la evasión del usuario.",
		shortDesc: "Actúa primero. Sube evasión 1 nivel.",
		gen7: {
			desc: "Siempre produce un golpe crítico.",
			shortDesc: "Casi siempre actúa primero. Siempre golpe crítico.",
		},
	},
};
