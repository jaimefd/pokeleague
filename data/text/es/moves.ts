export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	meteorbeam: {
		name: "Rayo meteórico",
		desc: "Este ataque se carga el primer turno y ataca en el segundo. Sube 1 nivel el Ataque Especial del usuario en el primer turno. Si el usuario lleva Hierba única, el movimiento se completa en un turno.", // “Hierba única” :contentReference[oaicite:1]{index=1}
